...
```javascript
MONGO_URL =
  "mongodb+srv://<username>:<password>@cluster0.ropxgna.mongodb.net/lucky?retryWrites=true&w=majority";
...
mkdir lucky
cd lucky
git clone https://github.com/Bonekyaw/node-express-nosql-rest.git .
rm -rf .git
npm install
npm start
